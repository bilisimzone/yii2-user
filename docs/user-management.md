...
```
if (Yii::$app->session->has(\coreb2c\user\controllers\AdminController::ORIGINAL_USER_SESSION_KEY))
    echo Html::a(
...
echo Nav::widget([
    ...
    'items' => [
        Yii::$app->session->has(\coreb2c\user\controllers\AdminController::ORIGINAL_USER_SESSION_KEY) ?
...
```
    'modules' => [
        'user' => [
            'controllerMap' => [
                'admin' => [
                    'class' => 'coreb2c\user\controllers\AdminController',
                    'as access' => [
