...
namespace coreb2c\user\controllers;

use coreb2c\user\Finder;
use coreb2c\user\models\RecoveryForm;
use coreb2c\user\models\Token;
use coreb2c\user\traits\AjaxValidationTrait;
use coreb2c\user\traits\EventTrait;
...
class RecoveryController extends Controller
{
     ...
     * Triggered with \coreb2c\user\events\FormEvent.
     */
     ...
     * Triggered with \coreb2c\user\events\ResetPasswordEvent. May not have $form property set.
     */
     ...
     * Triggered with \coreb2c\user\events\ResetPasswordEvent.
     */
